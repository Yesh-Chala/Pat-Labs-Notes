...
But, I also went through some literature and a lot of researchers always use self reported measures or digital usage, which are not always accurate. So, this morning at a coffee shop I had this crazy idea why don't I build something like that. I am at an unique position, I have a computer science background, I can think systems, I am an okay programmer, I also have knowledge about digital wellbeing and cultures, and maybe I could also find other people interested in doing this. 

I feel this is essential for easier progress in the field of digital wellbeing and digital cultures research. I honestly don't know if there is something like this already, but in an obscure place. But another important and interesting aspect is user concerns, I also want to look at what kinds of data are users comfortable with sharing with researchers, if privacy and anonymity was guaranteed. I feel like this will better help researchers design studies and observe variables that they are more likely to have access to. 

==And potentially, this endeavour could do two things.== 
1. ==Create a general purpose test bed for digital wellbeing researchers to utilise in studies.==
...
I understand there is a lot to do with this, a structured user research phase, stakeholder reviews, finding interested developers and the biggest problems funding and figuring out a single solution for all platforms, cause digital devices are wild and with OS changes come a lot of changes, a lot of things to figure out, but also it'll be worth going through the effort. I think.